...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="list-booking" class="col-12 content scaffold-list" role="main">
                    <h1>  <g:if test="${person}">${person?.firstName} ${person.lastName}'s</g:if>
                    ...
                    <g:if test="${bookingCount > params.int('max')}">
